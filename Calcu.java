...
public class Calcu extends javax.swing.JFrame {
    ...
    public Calcu() {
        initComponents();
        jRadioButton1.setEnabled(false); /* ON/OFF BUTTON */
    }

    double num1,num2,result; /* +, -, x, /, %, x^y */
    double num3;
    int stage = 0;
    String opr; /* +, -, x, /, %, x^y */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       /* Raised a number (x) to the power of another number (y^z) */ /*NOT SUREE */
       num1 = Double.parseDouble(jTextField1.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     /* ADDITION BETWEEN TWO VARIABLES (X+Y) */
        num1 = Double.parseDouble(jTextField1.getText());
